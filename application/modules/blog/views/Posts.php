...
<div class="col-md-12">
   <div class="panel panel-success">
      <div class="panel-heading">
         <h2><i class="fa fa-file-text-o" aria-hidden="true"></i>Add New Post</h2>
      ...
      <div class="panel-body">
         <div class="row">
            <div class="col-md-12">
               ...
               <form action="<?= base_url('blog/Posts/add_post') ?>" enctype="multipart/form-data" method="post" class="form-horizontal blog_settings row-border">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-4">
                        <textarea name="meta_desc" class="form-control" rows="5" placeholder="Description Must be within 150 characters" required></textarea>
                     </div>
                     <label class="col-sm-2 control-label text-success">Meta Keywords</label>
                     <div class="col-sm-4">
                        <textarea name="meta_keyword" class="form-control" rows="5" placeholder="keyword1,keyword2 etc" required></textarea>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-10">
                        <textarea name="content" id="summernote" class="form-control" rows="5" required></textarea>
                     </div>
                  </div>
