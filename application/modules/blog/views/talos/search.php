	...
	================================================== -->
		...
		<div class="section back-white" id="blog">
			<div class="section padding-bottom padding-top-page">
				...
				<?php foreach ($search as $search_post): ?>
						
					<div class="six columns" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.3s">
						<div class="journal-wrap">
							<img  src="<?= base_url($search_post->featured_img) ?>" width="100" height="400" alt="posts"/>
							<div class="journal-det">
								<h6><span><?php echo date("d-m-Y", strtotime($search_post->created_at)) ?>.</span></h6>
								<h5>
									<?php echo $search_post->title ?>.
								</h5>
								<a href="<?php bs() ?>blog/post/<?php echo $search_post->slug ?>">
